...
func (n Node) ChildByFieldId(fieldId uint16) (Node, bool) {
...
func (n Node) FirstChildForByte(byteOffset uint) (Node, bool) {
	return newNode(C.ts_node_first_child_for_byte(n._inner, C.uint(byteOffset)))
}

// Get the node's first named child that contains or starts after the given byte offset.
func (n Node) FirstNamedChildForByte(byteOffset uint) (Node, bool) {
...
func (n Node) NamedDescendantForByteRange(start, end uint) (Node, bool) {
